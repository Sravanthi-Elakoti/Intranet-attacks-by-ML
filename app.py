...
def viewdata():
    # Load the dataset
    dataset_path = 'C:\Users\Sravanthi\Downloads\Intranet Attacks by Ml\TK186247---An Advanced Approach for Detecting Behavior-Based Intranet Attacks by Machine Learning\CODE\FRONTEND\uploads\data.csv'  # Make sure this path is correct to the uploaded file
    df = pd.read_csv('C:\Users\Sravanthi\Downloads\Intranet Attacks by Ml\TK186247---An Advanced Approach for Detecting Behavior-Based Intranet Attacks by Machine Learning\CODE\FRONTEND\uploads\cleaned_dataset.csv')
    df = df.head(1000)
